...
const partnerNames = ['Andrea', 'George', 'Levon', 'Marion', 'Willow'];

const locations = ['Germany', 'Luxembourg', 'Portugal', 'Netherlands', 'Spain'];

const jobTitles = ['Web Developer', 'Massager', 'Entrepreneur', 'Freelancer', 'Mobile Developer'];
